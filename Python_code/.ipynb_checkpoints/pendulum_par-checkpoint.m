...
%
    pendulum_sim;
import pandas as pd 
X = pd.read_csv('MATLAB_code_20130826/Python_code/X.csv', header=None).values[None,:,:].T
Y = pd.read_csv('MATLAB_code_20130826/Python_code/Y.csv', header=None).values[None,:,:].T
